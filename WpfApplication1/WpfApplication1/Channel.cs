...
namespace WpfApplication1
{
    public class Channel
    {
        ...
        float highPassLevel, lowPassLevel, reverbLevel = 0;
        FMOD.DSP dspLowPass, dspHighPass, dspReverb = new FMOD.DSP();
        ...
        public void Initialize(int index)
        {
            ...
            fmodSystem.createDSPByType(DSP_TYPE.REVERB, ref dspReverb);
            fmodSystem.addDSP(dspReverb, ref con);
            SetReverb(0);
        ...
        public void SetReverb(float input)
        {
            if (input > 100) reverbLevel = 100;
            else if (input < 0) reverbLevel = 0;

            result = dspReverb.setParameter((int)DSP_REVERB.WETMIX, reverbLevel);
            Sample.ERRCHECK(result);
        }
